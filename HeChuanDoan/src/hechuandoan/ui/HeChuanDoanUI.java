...
public class HeChuanDoanUI extends JFrame{
	...
	private void addControls() {
		...
		btnTC=new JButton(); btnTC.setAlignmentX(Component.CENTER_ALIGNMENT);
		btnTC.setIcon(new ImageIcon("Icon/img_next.png"));
		btnTC1=new JButton(); btnTC1.setAlignmentX(Component.CENTER_ALIGNMENT);
		btnTC1.setIcon(new ImageIcon("Icon/img_pre.png"));
		
		btnTC.setPreferredSize(new Dimension(20, 60));
		btnTC1.setSize(50, 50);
		
		pnButtonTC.add(btnTC); 
		pnButtonTC.add(btnTC1);
		pnCenter.add(pnButtonTC);
		
		TitledBorder titleCenter=new TitledBorder(BorderFactory.createLineBorder(Color.GRAY), "Lựa chọn");
		...
		tblTC1.getColumnModel().getColumn(0).setPreferredWidth(15);
		tblTC1.getColumnModel().getColumn(1).setPreferredWidth(200);
